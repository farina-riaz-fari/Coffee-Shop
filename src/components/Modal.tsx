...
import { Image, Modal as RNModal, SafeAreaView, StyleProp, StyleSheet, Text, TouchableOpacity, View, ViewStyle } from "react-native";
...
const Modal: React.FC<ModalProps> = ({ visible, onClose, children, title, selectedType, setSelectedType, showTitle = false, modalPosition, modalWidth = "80%" }) => {
